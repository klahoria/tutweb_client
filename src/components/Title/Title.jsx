...
function Title(props) {
    return (
        <div className='text-center'>
            ...
            {props.title && <h3 className='d-md-none d-block text-start'>{props.title} {props.breakPoint && <>{props.breakPoint}</>}{props.gradient && <span style={{ color: props.gradientColor }}> {props.gradient}</span>}</h3>}
